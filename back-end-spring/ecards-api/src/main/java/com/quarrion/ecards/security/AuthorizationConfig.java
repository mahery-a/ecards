...
import com.quarrion.ecards.service.TokenBlackListService;

@Configuration
@EnableAuthorizationServer
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter {

    private Logger logger = Logger.getLogger(AuthorizationConfig.class.getName());
    ...
    static class MyTokenService extends DefaultTokenServices {
        Logger logger = Logger.getLogger(MyTokenService.class.getName());
